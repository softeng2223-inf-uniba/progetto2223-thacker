...
public class GameControllerTest {
    ...
    /**
     * 23) Test: Verifica che il metodo strike() non lanci
     * un'eccezione se invocato durante una sessione di gioco e
     ...
     * Verifica che il metodo strike() non lanci
     * un'eccezione se invocato durante una sessione di gioco e
     * possa colpire coordinate all'estremo superiore della mappa standard.
     * <p>
     *  Atteso: eccezione non lanciata
     */
    @Test
    ...
    // fine casi limite strike

    /**
     * 26) Test: caso limite ->
     * Verifica che il metodo strike() non lanci
     * un'eccezione se invocato durante una sessione di gioco e
     * possa colpire coordinate all'estremo superiore della mappa large.
     * <p>
     *  Atteso: eccezione non lanciata
     */
    @Test
     ...
     * Verifica che il metodo strike() non lanci
     * un'eccezione se invocato durante una sessione di gioco e
     * possa colpire coordinate all'estremo superiore della mappa extralarge.
     * <p>
     *  Atteso: eccezione non lanciata
     */
    @Test
    ...
    /**
     * 28) Test: Verifica che il metodo strike() non lanci
     * un'eccezione se invocato durante una sessione di gioco con
     * coordinate che contengono 'acqua'.
     * <p>
